...
- (void)setupCompletionButton
{
    ...
    // Commented out because this is pretty much useless.
    //[completionButton addTarget:self action:@selector(completionButtonAction) forControlEvents:UIControlEventTouchUpInside];
